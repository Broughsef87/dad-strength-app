...
export default function RecoveryProtocol() {
    ...
    <div className="tile relative rounded-xl p-6 pt-8">
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-2">
          <Snowflake size={16} className={complete ? 'text-status-good-ink' : 'text-brand'} />
 ...
 active ? 'border-status-good-fill/40 bg-status-good-fill/5' : 'border-border/60 bg-background/40'
 }`}
            >
              <button
                ...
                title="Log a session"
              >
                <s.Icon size={15} className={active ? 'text-status-good-ink' : 'text-muted-foreground'} />
 ...
 active ? 'border-status-good-fill/50 text-status-good-ink hover:bg-status-good-fill/10' : 'border-border/60 text-muted-foreground hover:text-brand hover:border-brand/50'
 }`}>
                  <Plus size={11} />
                </button>
              </div>
