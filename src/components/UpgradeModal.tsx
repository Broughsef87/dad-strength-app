          ...
          >
            ...
            <div className="px-6 pb-6 space-y-2.5">
              ...
              <button
                ...
                disabled={!!loading}
                className="annual-card w-full flex items-center justify-between p-4 rounded-lg relative transition-all disabled:saturate-[.15] disabled:**:text-muted-foreground"
              >
              ...
              <button
                ...
                disabled={!!loading}
                className="w-full flex items-center justify-between p-4 rounded-lg border border-border/60 hover:border-border bg-muted/20 hover:bg-muted/30 transition-all disabled:saturate-[.15] disabled:**:text-muted-foreground"
              >
                <div className="text-left">
              ...
              <button
                ...
                disabled={!!loading}
                className="w-full flex items-center justify-between p-4 rounded-lg border border-border/40 hover:border-border/70 bg-muted/10 hover:bg-muted/20 transition-all disabled:saturate-[.15] disabled:**:text-muted-foreground"
              >
