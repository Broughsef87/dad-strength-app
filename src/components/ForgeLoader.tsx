    ...
    <div className={`flex flex-col items-center gap-4 ${className}`}>
      <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
        ...
        <span
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(255,176,32,0.25) 0%, rgba(255,176,32,0) 70%)',
          }}
          aria-hidden="true"
        />
        {/* Steel core disc */}
        <span
          ...
          style={{
            ...
            boxShadow:
              '0 0 14px 1px rgba(255,176,32,0.35), inset 0 1px 0 rgba(255,229,166,0.08)',
          }}
          aria-hidden="true"
        />
        {/* Rotating amber arc */}
        ...
        >
          <defs>
            <linearGradient id="forge-loader-arc" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="50%" stopColor="#D68A00" />
          ...
          <circle
            ...
            style={{ filter: 'drop-shadow(0 0 3px rgba(255,176,32,0.6))' }}
          />
        </svg>
      </div>
      {label && (
