  ...
  return (
    ...
    >
      ...
      <ellipse cx="42" cy="70" rx="40" ry="64"
        stroke="rgba(234,11,47,0.18)" strokeWidth="1.5" />
      {/* Inner ring on disc */}
      <ellipse cx="42" cy="70" rx="28" ry="46"
        stroke="rgba(234,11,47,0.11)" strokeWidth="1.2" />
      {/* Center hub hole */}
      <circle cx="42" cy="70" r="7"
        stroke="rgba(234,11,47,0.20)" strokeWidth="1.5" />

      {/* Thin bumper plate */}
      <ellipse cx="86" cy="70" rx="9" ry="26"
        stroke="rgba(234,11,47,0.13)" strokeWidth="1.5" />

      {/* Collar */}
      <rect x="97" y="55" width="9" height="30" rx="2"
        fill="rgba(234,11,47,0.07)"
        stroke="rgba(234,11,47,0.22)" strokeWidth="1" />

      {/* ── BAR ───────────────────────────────────────────────────── */}
      <line x1="106" y1="70" x2="294" y2="70"
        stroke="rgba(234,11,47,0.26)" strokeWidth="3.5"
        strokeLinecap="round" />

      {/* Knurling — cross-hatch marks at center section */}
      {[130, 148, 166, 184, 200, 218, 234, 252, 270].map(x => (
        <line key={x} x1={x} y1="63" x2={x} y2="77"
          stroke="rgba(234,11,47,0.09)" strokeWidth="1" />
      ))}
  ...
  return (
    ...
    >
      ...
      <polygon points="100,36 164,100 100,164 36,100"
        stroke="rgba(234,11,47,0.12)" strokeWidth="1.5" />
      <polygon points="100,64 136,100 100,136 64,100"
        stroke="rgba(234,11,47,0.08)" strokeWidth="1.5" />
      <line x1="100" y1="80" x2="100" y2="120" stroke="rgba(234,11,47,0.12)" strokeWidth="1" />
      <line x1="80"  y1="100" x2="120" y2="100" stroke="rgba(234,11,47,0.12)" strokeWidth="1" />
      <circle cx="100" cy="100" r="4" fill="rgba(234,11,47,0.22)" />
    </svg>
  )
}
  ...
  return (
    ...
    >
      <line x1="0" y1="10" x2="136" y2="10"
        stroke="rgba(234,11,47,0.15)" strokeWidth="0.75" />
      <polygon points="150,4 157,10 150,16 143,10"
        fill="rgba(234,11,47,0.28)" />
