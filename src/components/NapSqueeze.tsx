...
export default function NapSqueeze() {
  return (
    <div className="bg-card border-2 border-brand/30 rounded-[32px] overflow-hidden relative group">
      {/* Background Glow */}
      <div className="absolute top-0 right-0 w-32 h-32 bg-brand/10 blur-[50px] -mr-16 -mt-16 group-hover:bg-brand/20 transition-colors" />
