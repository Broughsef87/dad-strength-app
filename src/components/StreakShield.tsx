      ...
      {!usedThisMonth && !activeToday && (
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-brand text-background text-sm font-semibold tracking-wide hover:opacity-90 active:scale-[0.97] transition-all"
          >
            <Shield size={15} />
            Activate Shield
          </button>
