        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <button
              ...
              className="flex items-center gap-2 bg-brand text-brand-ink text-xs font-black uppercase tracking-widest px-4 py-2 rounded-full shadow-lg hover:bg-brand/90 transition-all active:scale-95"
            >
