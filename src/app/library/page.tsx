      ...
      <main className="p-4 space-y-3 max-w-md mx-auto">
        {filtered.length === 0 ? (
          <div className="text-center py-20 opacity-30">
            ...
            <p className="text-sm font-bold lowercase">No exercises found.</p>
          </div>
        ) : (
          filtered.map((ex) => {
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  disabled={!!loadingId}
                  className="flex items-center gap-1.5 bg-brand hover:bg-brand/90 disabled:opacity-40 text-brand-ink text-[10px] font-display font-semibold px-3 py-2.5 rounded-xl transition-all active:scale-95 lowercase ml-3 flex-shrink-0 shadow-lg shadow-brand/10"
                >
                  {isLoading
