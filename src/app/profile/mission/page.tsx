  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      <header className="flex items-center gap-4 border-b border-border bg-surface-2 px-6 py-4 sticky top-0 z-10">
        ...
        <h1 className="text-xl font-display font-semibold uppercase tracking-[0.08em]">My Mission</h1>
      </header>
      ...
      <main className="max-w-md mx-auto p-6 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] uppercase text-muted-foreground font-medium tracking-[0.08em]">Mission Name</label>
          <input
            type="text"
            value={title}
        ...
        {/* Description */}
        <div className="space-y-2">
          <label className="text-[10px] uppercase text-muted-foreground font-medium tracking-[0.08em]">What does it look like when you get there?</label>
          <textarea
            value={description}
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label className="text-[10px] uppercase text-muted-foreground font-medium tracking-[0.08em]">Progress</label>
        ...
        {/* Next Milestone */}
        <div className="space-y-2">
          <label className="text-[10px] uppercase text-muted-foreground font-medium flex items-center gap-1.5 tracking-[0.08em]">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 bg-brand hover:bg-brand/90 disabled:opacity-50 text-[hsl(var(--brand-ink))] font-display font-semibold py-4 rounded-xl uppercase text-sm transition-all active:scale-[0.98] tracking-[0.08em]"
        >
        ...
        {title && (
          ...
          >
            <p className="text-[10px] uppercase text-muted-foreground font-medium tracking-[0.08em]">Mission Preview</p>
            <h3 className="text-lg font-display font-semibold uppercase tracking-[0.08em]">{title}</h3>
