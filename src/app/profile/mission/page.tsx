    ...
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <main className="max-w-md mx-auto p-6 space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 bg-brand hover:bg-brand/90 disabled:opacity-50 text-brand-ink font-display font-semibold py-4 rounded-xl lowercase text-sm transition-all active:scale-[0.98]"
        >
