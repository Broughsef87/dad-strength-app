      ...
      <main className="max-w-md mx-auto p-6 space-y-8">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-green-900 to-gray-900 rounded-3xl p-8 border border-green-500/30 shadow-2xl">
           ...
           <div className="space-y-2 relative z-10">
              ...
              <div className="h-3 w-full bg-background/50 rounded-full overflow-hidden border border-green-900">
        ...
        <div className="grid grid-cols-2 gap-4">
           ...
           <div className="bg-card rounded-2xl p-4 border border-border group hover:border-gray-700 transition-colors">
             ...
             <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest mb-1">YouTube Subs</p>
             <p className="font-bold text-xl">12,450</p>
             <p className="text-[10px] text-muted-foreground mt-1">+450 this month</p>
           </div>
           ...
           <div className="bg-card rounded-2xl p-4 border border-border group hover:border-gray-700 transition-colors">
             ...
             <p className="text-[10px] text-muted-foreground mt-1">+15% vs last month</p>
           </div>
        </div>
              ...
              <div className="flex justify-between items-center group cursor-pointer hover:bg-gray-800/50 p-2 rounded-xl transition-all -m-2">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider mt-0.5">Video Scripting</p>
                    </div>
                 </div>
                 <span className="text-xs font-mono text-muted-foreground border border-gray-700 px-2 py-1 rounded">Draft</span>
              </div>
              ...
              <div className="flex justify-between items-center group cursor-pointer hover:bg-gray-800/50 p-2 rounded-xl transition-all -m-2">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider mt-0.5">Community Build</p>
                    </div>
                 </div>
                 <span className="text-xs font-mono text-muted-foreground border border-gray-700 px-2 py-1 rounded">124 Members</span>
              </div>
