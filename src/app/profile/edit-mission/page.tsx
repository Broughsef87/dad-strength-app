    ...
    <div className="min-h-screen bg-background text-foreground font-sans pb-24">
      <header className="flex items-center justify-between border-b border-border bg-surface-2 p-6 sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-display font-semibold italic uppercase italic tracking-[0.08em]">Mission Editor</h1>
        </div>
        <button 
          onClick={handleSave}
          className="bg-brand hover:bg-brand/90 text-[hsl(var(--brand-ink))] px-4 py-1.5 rounded-lg font-display font-semibold text-xs uppercase transition-all shadow-lg shadow-brand/20 flex items-center gap-2 tracking-[0.08em]"
        >
          <Save size={14} /> Save
        </button>
      </header>
      ...
      <main className="max-w-md mx-auto p-6 space-y-10">
        ...
        <section className="space-y-4">
          <label className="text-xs uppercase font-display font-semibold tracking-[0.2em] text-muted-foreground pl-1">Project Identity</label>
          <div className="space-y-4 bg-card/40 p-6 rounded-3xl border border-border">
             <div>
                <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">Pillar Name</label>
                <input 
                  type="text" 
                  value={mission.title}
             ...
             <div>
                <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">North Star Name</label>
                <input 
                  type="text" 
        ...
        <section className="space-y-4">
          <label className="text-xs uppercase font-display font-semibold tracking-[0.2em] text-muted-foreground pl-1">Progress Tracking</label>
          <div className="bg-card/40 p-6 rounded-3xl border border-border space-y-6">
             <div className="grid grid-cols-2 gap-4">
                <div>
                   <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">Current Value</label>
                   <input 
                     type="number" 
                ...
                <div>
                   <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">Target Value</label>
                   <input 
                     type="number" 
             ...
             <div>
                <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">Unit Type</label>
                <div className="flex gap-2">
                   {['$', 'LBS', '%', 'HRS', 'QTY'].map(u => (
                     <button
                       key={u}
                       onClick={() => setMission({...mission, unit: u})}
                       className={`flex-1 py-2 rounded-lg text-[10px] font-display font-semibold uppercase border transition-all ${
                         mission.unit === u 
        ...
        <section className="space-y-4">
          <label className="text-xs uppercase font-display font-semibold tracking-[0.2em] text-muted-foreground pl-1">Secondary Stats</label>
          ...
          {[1, 2].map((num) => {
            ...
            return (
              <div key={num} className="bg-card/40 p-6 rounded-3xl border border-border space-y-4">
                 <div className="grid grid-cols-2 gap-4">
                    <div>
                       <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">Stat Label</label>
                       <input 
                         type="text" 
                    ...
                    <div>
                       <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2">Current Stat</label>
                       <input 
                         type="text" 
                 ...
                 <div>
                    <label className="text-[10px] uppercase font-display font-semibold tracking-widest text-muted-foreground block mb-2 text-center">Icon Select</label>
