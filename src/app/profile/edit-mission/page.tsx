  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans pb-24">
      <header className="flex items-center justify-between border-b border-border bg-surface-2 p-6 sticky top-0 z-10">
        ...
        <button 
          onClick={handleSave}
          className="bg-brand hover:bg-brand/90 text-brand-ink px-4 py-1.5 rounded-lg font-display font-semibold text-xs lowercase transition-all flex items-center gap-2"
        >
          <Save size={14} /> Save
        </button>
      </header>
