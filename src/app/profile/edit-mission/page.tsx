    ...
    <div className="min-h-screen bg-background text-foreground font-sans pb-24">
      <header className="flex items-center justify-between border-b border-border bg-surface-2 p-6 sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-display font-semibold italic lowercase italic">Mission Editor</h1>
        </div>
        <button 
          onClick={handleSave}
          className="bg-brand hover:bg-brand/90 text-brand-ink px-4 py-1.5 rounded-lg font-display font-semibold text-xs lowercase transition-all shadow-lg shadow-brand/20 flex items-center gap-2"
        >
          <Save size={14} /> Save
        </button>
      </header>
      ...
      <main className="max-w-md mx-auto p-6 space-y-10">
        ...
        <section className="space-y-4">
          <label className="text-xs lowercase font-display font-semibold tracking-[0.2em] text-muted-foreground pl-1">Progress Tracking</label>
        ...
        <section className="space-y-4">
          <label className="text-xs lowercase font-display font-semibold tracking-[0.2em] text-muted-foreground pl-1">Secondary Stats</label>
