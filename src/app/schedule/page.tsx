          ...
          {todayData?.hasWorkout ? (
            ...
            <div className="bg-card border border-border rounded-3xl p-5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-brand hover:bg-brand/90 text-brand-ink font-display font-semibold py-4 rounded-2xl lowercase text-xs transition-all active:scale-95 shadow-lg shadow-brand/20"
              >
