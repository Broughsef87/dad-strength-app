...
const MONTHLY_THEMES: MonthlyTheme[] = [
  ...
  },
  {
    ...
    skillProgression: 'Snatch skill focus: Week 1 positional work (hang), Week 2 full snatch from floor, Week 3 heavy singles, Week 4 Isabel or similar benchmark. IMPORTANT: whenever any snatch variation (Hang Power Snatch, Power Snatch, Squat Snatch) appears as a strength block, ALWAYS pair it with a squat variation as the next block. Choose whichever squat fits best — Overhead Squat (reinforces receiving position), Front Squat (builds positional strength), or Back Squat (general leg strength). Never program a snatch block without a squat companion during Snatch Month.',
