    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-display font-semibold lowercase">Privacy Policy</h1>
        ...
        <div className="prose-paper space-y-8 text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">Your Rights</h2>
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-display font-semibold lowercase text-foreground mb-3">Changes to This Policy</h2>
            <p>
